...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    @foreach($property->images as $image)
        <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url('{{ asset('images/' . $image->url) }}'); " data-aos="fade" data-stellar-background-ratio="0.5">
        </div>
    @endforeach
@endforeach
          ...
          <div class="col-lg-8">
            <div>
              <div class="slide-one-item home-slider owl-carousel">
                <div><img src="{{asset('images/hero_bg_1.jpg')}}" alt="Image" class="img-fluid"></div>
                <div><img src="{{asset('images/hero_bg_2.jpg')}}" alt="Image" class="img-fluid"></div>
                <div><img src="{{asset('images/hero_bg_3.jpg')}}" alt="Image" class="img-fluid"></div>
              </div>
            </div>
            <div class="bg-white property-body border-bottom border-left border-right">
              ...
              <div class="row no-gutters mt-5">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="{{asset('images/img_1.jpg')}}" class="image-popup gal-item"><img src="{{asset('images/img_1.jpg')}}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="{{asset('images/img_2.jpg')}}" class="image-popup gal-item"><img src="{{asset('images/img_2.jpg')}}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="{{asset('images/img_3.jpg')}}" class="image-popup gal-item"><img src="{{asset('images/img_3.jpg')}}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="{{asset('images/img_4.jpg')}}" class="image-popup gal-item"><img src="{{asset('images/img_4.jpg')}}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="{{asset('images/img_5.jpg')}}" class="image-popup gal-item"><img src="{{asset('images/img_5.jpg')}}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="{{asset('images/img_6.jpg')}}" class="image-popup gal-item"><img src="{{asset('images/img_6.jpg')}}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="{{asset('images/img_7.jpg')}}" class="image-popup gal-item"><img src="{{asset('images/img_7.jpg')}}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="{{asset('images/img_8.jpg')}}" class="image-popup gal-item"><img src="{{asset('images/img_8.jpg')}}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="{{asset('images/img_1.jpg')}}" class="image-popup gal-item"><img src="{{asset('images/img_1.jpg')}}" alt="Image" class="img-fluid"></a>
                </div>
