                ...
                <div class="col-lg-8">
                  <div>
                    <div class="slide-one-item home-slider owl-carousel">
                      <div><img src="{{asset('images/' . $img->url)}}" alt="Image" class="img-fluid"></div>
             ...
             <div class="col-md-6 col-lg-4 mb-4">
                <div class="property-entry h-100">
                  ...
                  <div class="p-4 property-body">
                    ...
                    <h2 class="property-title"><a href="property-details.html">{{$category->name}}</a></h2>
                    <span class="property-location d-block mb-3"><span class="property-icon icon-room"></span> {{$category->address}}, <br> {{$category->city}}</span>
                    <strong class="property-price text-primary mb-3 d-block text-success">${{$category->price}}</strong>
