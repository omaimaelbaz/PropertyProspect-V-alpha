                                                ...
                                                <div class="offer-type-wrap">
                                                    @foreach (['sale', 'soldout', 'rent'] as $status)
                                                        @if ($prop->status == $status)
                                                            ...
                                                            @endphp
                                                            <span
                                                                class="offer-type {{ $class }}">{{ $prop->status }}</span>
                                                        @endif
                                                    @endforeach
                                                </div>

                                                <img src="{{ 'images/' . $img->url }}" alt="Image"
                                                    class="img-fluid">
                                            </a>
                                        @endforeach
                                            ...
                                            <ul class="property-specs-wrap mb-3 mb-lg-0">
                                                <li>
                                                    ...
                                                    <span class="property-specs-number">
                                                        {{ $prop->num_bedrooms }}</span>

                                                </li>
                                                <li>
                                                    <span class="property-specs">Baths</span>
                                                    <span
                                                        class="property-specs-number">{{ $prop->num_bathrooms }}</span>
                            ...
                            <div class="team-member">
                                ...
                                <div class="text">
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi dolorem totam non
                                        quis
                                        facere blanditiis praesentium est. Totam atque corporis nisi, veniam non.
                                        Tempore
                                        cupiditate, vitae minus obcaecati provident beatae!</p>
                                    <p>
                                        <a href="#" class="text-black p-2"><span
                            ...
                            <div class="team-member">
                                ...
                                <div class="text">
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores illo iusto,
                                        inventore,
                                        iure dolorum officiis modi repellat nobis, praesentium perspiciatis, explicabo.
                                        Atque
            ...
            <footer class="site-footer">
                <div class="container">
                    ...
                    <div class="row pt-5 mt-5 text-center">
                        <div class="col-md-12">
                            <p>
                                Copyright &copy; All rights reserved <i class="icon-heart text-danger"
                                    aria-hidden="true"></i>
                                by Omaima Elbaz</a>
                            </p>
                        </div>
