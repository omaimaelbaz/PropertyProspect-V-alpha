    ...
    <div class="site-wrap">
        ...
        <style>
            .navbarhome {
                ...
                left: 0;
                width: 100%;
                /* background:linear-gradient(to right, #d7cedc, #766988) !important; */
                /* background: linear-gradient(to right, rgba(255, 255, 255, 0.5), #9886b1) !important; */
                background: linear-gradient(to right, #c6e39c, #9886b1) !important;
                z-index: 1000;
            }
            ...
            .navhome ul li:hover ul.dropdown {
                display: block;
            }
        </style>
    ...
    <footer class="site-footer">
        <div class="container">
            ...
            <div class="row pt-5 mt-5 text-center">
                <div class="col-md-12">
                    <p>
                        Copyright &copy; All rights reserved <i class="icon-heart text-danger" aria-hidden="true"></i>
                        by Omaima Elbaz</a>
                    </p>
                </div>
